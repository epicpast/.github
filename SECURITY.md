...
The epicpast organization takes security seriously. We appreciate responsible disclosure of security vulnerabilities.

### How to Report

**GitHub Security Advisories**: Use GitHub's private vulnerability reporting feature on the affected repository.
...
**In Scope**:
- Source code in epicpast repositories
